...
%	\bibliographystyle{ieeetr}
  ...
  \addcontentsline{toc}{chapter}{BIBLIOGRAPHY}
	\bibliography{./robots.bib,./hubo-ach-ram.bib,./hubo-ach.bib,./dis.bib,./srm/throwing.bib,./pitch/throwing.bib,./mitigation/mit.bib,./hubo-ach/hubo-ach.bib,./hubo-ach/bibtech.bib}
