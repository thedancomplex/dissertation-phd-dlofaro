...
\begin{figure}[t]
  \centering
\includegraphics[width=0.69\columnwidth]{./pix/hubo-pitch.png}
...
Section~\ref{sec:baseball} describes the three different methods tested where:
...
Finally Section~\ref{sec:throw:conclusion} gives final thoughts and possible improvements for future years.
