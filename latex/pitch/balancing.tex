...
Fig.~\ref{fig:oneFootBalanceVideo} shows the example of the Hubo balancing using the above method.

\begin{figure}[thpb]
  \centering
\includegraphics[width=0.6\columnwidth]{./pix/onefoot.png}
\includegraphics[width=0.3\columnwidth]{./qrcode/qrcode-onefoot.png}\\
      Video: http://danlofaro.com/phd/balance/
  \caption{Hubo Balancing using method discribed in Section~\ref{sec:sec:balance}}
  \label{fig:oneFootBalanceVideo}
\end{figure}
